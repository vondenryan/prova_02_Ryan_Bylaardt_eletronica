...
- Ativa box-sizing border-box

**Estilo Body:**
- Fonte: 'Inter' com fallbacks
- Fundo cinza claro (#f0f2f5)
- Flexbox centered (justify-content, align-items)
- Altura mínima de 100vh

**Container Principal:**
- Fundo branco
- Largura responsiva (90%, máx 400px)
- Padding 30px
- Border-radius 20px
- Sombra suave
...
**Header:**
- Centralizado
- H2: 1.25rem, cor escura
- Parágrafo: 0.8rem, cor cinza

**Type Selector (Radio Buttons):**
- Flexbox com gap 10px
- Label com styling customizado
- Cor azul (#007bff) quando selecionado
- Input hidden

**Resistor Preview:**
- Flexbox centered
- Corpo do resistor: 130x42px, cor bege (#e3c598)
- Faixas: 8px de largura, altura 100%
- Fios: 30x4px, cor cinza

**Seletores (Dropdowns):**
- Grid 2 colunas
- Gap 15px
- Select: padding 10px, border 1px cinza
...
- Padding 15px
- Border-radius 12px
- Efeito ativo muda fundo para azul claro

**Display de Resultado:**
- Fundo azul claro (#cbdef1)
- Padding 20px
- Border-radius 12px
- Small: 0.75rem cinza
- Strong: 1.5rem preto
